...
//   Date: 2016-12-01 22:33:16

namespace TravelLibs\Protobuf {

  class Reservation extends \DrSlump\Protobuf\Message {

    /**  @var \TravelLibs\General */
    public $general = null;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'TravelLibs.Reservation');
      ...
      $f->reference = '\TravelLibs\General';
     ...
     * Set <general> value
     *
     * @param \TravelLibs\General $value
     * @return \TravelLibs\Reservation
     */
    public function setGeneral(\TravelLibs\General $value){
      return $this->_set(1, $value);
    }
  }
}

namespace TravelLibs\Protobuf\General {
...
namespace TravelLibs\Protobuf\General {
  ...
  class System extends \DrSlump\Protobuf\Enum {
    const travel = 0;
    const camper = 1;
  }
}
namespace TravelLibs\Protobuf\General {
  ...
  class TransactionType extends \DrSlump\Protobuf\Enum {
    const direct = 0;
    const reseller = 1;
  }
}
namespace TravelLibs\Protobuf\General {
  ...
  class PaymentType extends \DrSlump\Protobuf\Enum {
    const invoice = 0;
    const credit_card = 1;
  }
}
namespace TravelLibs\Protobuf {
  ...
  class General extends \DrSlump\Protobuf\Message {
    ...
    /**  @var int - \TravelLibs\General\Status */
    public $status = null;
    
    /**  @var int - \TravelLibs\General\System */
    public $system = null;
    
    /**  @var int - \TravelLibs\General\TransactionType */
    ...
    /**  @var int - \TravelLibs\General\PaymentType */
    ...
    /**  @var string[]  */
    public $consultant_notice = array();
    ...
    public static function descriptor()
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'TravelLibs.General');
      ...
      $f->rule      = \DrSlump\Protobuf::RULE_REQUIRED;
      $f->reference = '\TravelLibs\General\Status';
      $descriptor->addField($f);

      // REQUIRED ENUM system = 2
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 2;
      $f->name      = "system";
      $f->type      = \DrSlump\Protobuf::TYPE_ENUM;
      $f->rule      = \DrSlump\Protobuf::RULE_REQUIRED;
      $f->reference = '\TravelLibs\General\System';
      $descriptor->addField($f);

      // REQUIRED ENUM transaction_type = 3
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 3;
      $f->name      = "transaction_type";
      $f->type      = \DrSlump\Protobuf::TYPE_ENUM;
      $f->rule      = \DrSlump\Protobuf::RULE_REQUIRED;
      $f->reference = '\TravelLibs\General\TransactionType';
      $descriptor->addField($f);
      ...
      // REQUIRED STRING travel_type_sub = 8
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 8;
      ...
      // REQUIRED ENUM payment_type = 12
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 12;
      $f->name      = "payment_type";
      $f->type      = \DrSlump\Protobuf::TYPE_ENUM;
      $f->rule      = \DrSlump\Protobuf::RULE_REQUIRED;
      $f->reference = '\TravelLibs\General\PaymentType';
      $descriptor->addField($f);

      // REQUIRED DOUBLE payment_surcharge_amount = 13
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 13;
      ...
      // REQUIRED INT32 payment_surcharge_percentage = 14
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 14;
      ...
      // REQUIRED STRING ip_reffered = 15
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 15;
      $f->name      = "ip_reffered";
      $f->type      = \DrSlump\Protobuf::TYPE_STRING;
      ...
      // REPEATED STRING consultant_notice = 16
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 16;
      $f->name      = "consultant_notice";
      $f->type      = \DrSlump\Protobuf::TYPE_STRING;
      $f->rule      = \DrSlump\Protobuf::RULE_REPEATED;
      $descriptor->addField($f);

      // REPEATED STRING contractor_notice = 17
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 17;
     ...
     * Get <status> value
     *
     * @return int - \TravelLibs\General\Status
     */
     ...
     * Set <status> value
     *
     * @param int - \TravelLibs\General\Status $value
     * @return \TravelLibs\General
     */
     ...
     * Get <system> value
     *
     * @return int - \TravelLibs\General\System
     */
     ...
     * Set <system> value
     *
     * @param int - \TravelLibs\General\System $value
     * @return \TravelLibs\General
     */
     ...
     *
     * @return int - \TravelLibs\General\TransactionType
     */
     ...
     *
     * @param int - \TravelLibs\General\TransactionType $value
     * @return \TravelLibs\General
     */
     ...
     *
     * @return int - \TravelLibs\General\PaymentType
     */
     ...
     *
     * @param int - \TravelLibs\General\PaymentType $value
     * @return \TravelLibs\General
     */
    ...
    /**
     * Check if <consultant_notice> has a value
     *
     * @return boolean
     */
    public function hasConsultantNotice(){
      return $this->_has(16);
    }
    
    /**
     * Clear <consultant_notice> value
     *
     * @return \TravelLibs\General
     */
    public function clearConsultantNotice(){
      return $this->_clear(16);
    }
    
    /**
     * Get <consultant_notice> value
     *
     * @param int $idx
     * @return string
     */
    public function getConsultantNotice($idx = NULL){
      return $this->_get(16, $idx);
    }
    
    /**
     * Set <consultant_notice> value
     *
     * @param string $value
     * @return \TravelLibs\General
     */
    public function setConsultantNotice( $value, $idx = NULL){
      return $this->_set(16, $value, $idx);
    }
    
    /**
     * Get all elements of <consultant_notice>
     *
     * @return string[]
     */
    public function getConsultantNoticeList(){
     return $this->_get(16);
    }
    
    /**
     * Add a new element to <consultant_notice>
     *
     * @param string $value
     * @return \TravelLibs\General
     */
    public function addConsultantNotice( $value){
